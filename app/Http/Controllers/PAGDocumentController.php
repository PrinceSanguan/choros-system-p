...
class PAGDocumentController extends Controller
{
    /**
    ...
    /**
     * Store a newly created document for a PAG member.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  int  $pagId
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, $pagId)
    {
        // Find the PAG record
        $pag = PAG::find($pagId);
        ...
        foreach ($request->file('documents') as $document) {
            ...
            $pagDocument->save();
            $documents[] = $pagDocument;
        }

        return response()->json([
            'success' => true,
            'message' => 'PAG documents uploaded successfully',
            'data' => $documents
        ]);
    }
